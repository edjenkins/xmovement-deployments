...
@section('content')
  ...
  <div class="container-fluid hero-container" id="home-hero-container" style="background-image:url('{{ asset(getenv('APP_HOME_HEADER_IMG')) }}')">
      ...
      <div class="container text-container text-left">
        ...
        <ul>
          <li>How do we:</li>
          <li>Improve job opportunities in Stanley?</li>
          <li>Attract more visitors to Stanley?</li>
          <li>Make Stanley more attractive?</li>
          <li>Improve living in Stanley through up-skilling, training and apprenticeships?</li>
        </ul>
    ...
    <div class="container-fluid hero-container info-container" id="info-hero-container">
    <div class="container text-container text-left">
      <h1>Attend the Smart Stanley event</h1>

      <p>We are hosting a Smart Stanley event this May (2017) and would love your input. You can find out more about this exciting event by clicking below.</p>
