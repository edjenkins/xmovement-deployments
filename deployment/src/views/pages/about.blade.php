			...
			<div class="row about-phase-row">
				...
				<div class="col-md-12">
					...
					<div class="about-phase-tile animated fadeIn">
						<p>
							Have you ever wanted to make a difference to your community? Well now you can. Local partners are coming together with Newcastle University’s Open Lab to create a new and exciting activity as part of the Smart Stanley Project.
						</p>
						<p>
